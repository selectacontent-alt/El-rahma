                      ...
                      <div className="shipping-action-group">
                        ...
                        >
                          {dispatchingId === `${order.id}-Bosta` ? (
                            ...
                            <img src="/bosta-logo.png?v=20260717" alt="Bosta" style={{ height: '18px', objectFit: 'contain', filter: 'brightness(0) invert(1)' }} />
                          )}
                        </button>
                        <button
                          type="button"
                        ...
                        >
                          {dispatchingId === `${order.id}-Aramex` ? (
                            ...
                            <img src="/aramex-logo.png?v=20260717" alt="Aramex" style={{ height: '18px', objectFit: 'contain', filter: 'brightness(0) invert(1)' }} />
                          )}
                        </button>
                      </div>
                    )}
