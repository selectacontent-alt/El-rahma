...
const SECTION_LABELS = {
  nav: 'Navbar',
  hero: 'Hero Section',
  rahmaHome: 'Rahma Homepage',
  products: 'Products',
  cart: 'Cart',
  about: 'About Us',
  seoArticle: 'Grounding SEO Article',
...
const SECTION_LABELS_AR = {
  nav: 'شريط التنقل', hero: 'الواجهة الرئيسية', rahmaHome: 'الصفحة الرئيسية الجديدة', products: 'المنتجات', cart: 'السلة',
  about: 'من نحن', testimonials: 'آراء العملاء', footer: 'الفوتر', policy: 'السياسات',
  seoArticle: 'المقال التعريفي', governorates: 'المحافظات',
...
const TranslationEditor = () => {
  ...
  const sortedSections = ['nav', 'hero', 'rahmaHome', 'products', 'cart', 'about', 'seoArticle', 'governorates', 'testimonials', 'footer', 'policy', 'categories', 'checkout', 'checkoutNew', 'customerAuth', 'account', 'booking', 'media', 'homeMedia', 'b2b', 'login', 'app', 'whatsapp', 'tracking', 'translationSettings', 'admin']
    .filter(s => sectionKeys.includes(s))
    .concat(sectionKeys.filter(s => !['nav', 'hero', 'rahmaHome', 'products', 'cart', 'about', 'seoArticle', 'governorates', 'testimonials', 'footer', 'policy', 'categories', 'checkout', 'checkoutNew', 'customerAuth', 'account', 'booking', 'media', 'homeMedia', 'b2b', 'login', 'app', 'whatsapp', 'tracking', 'translationSettings', 'admin'].includes(s)));
