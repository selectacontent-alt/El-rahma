...
export const DEFAULT_ORDER_CONFIRMATION_TEMPLATE = [
  'مرحباً أ/ {customer_first_name}',
  'تم استلام طلبك رقم {order_id} بنجاح.',
  '{date_time}',
  '',
  'الاسم: {customer_full_name}',
...
export const DEFAULT_BOOKING_CONFIRMATION_TEMPLATE = [
  '*مصنع الرحمة لتشكيل المعادن*',
  '------------------------------',
  'تم استلام طلب التوريد بنجاح',
  '',
  ...
  '{notes_line}',
  '',
  'سيتم التواصل معك قريباً لتأكيد تفاصيل التجهيز والتسليم.',
  'شكراً لثقتك في *مصنع الرحمة*.'
].join('\n');
